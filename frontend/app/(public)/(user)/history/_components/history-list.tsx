import { getUserHistory } from "@/data/get-user-history";
import { HistoryDataTable } from "./history-data-table";

export default async function HistoryList() {
  const conversations = await getUserHistory();
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <p className="text-muted-foreground max-w-sm">
          Your conversation history will appear here once you start chatting with GPTs.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-primary">Your Conversations</h1>
