...
export function EditGptForm({ gptId, initialData }: EditGptFormProps) {
  ...
  const form = useForm<GptFormValues>({
    ...
    defaultValues: {
      ...
      voiceAgentEnabled: Boolean(initialData.voiceAgentEnabled ?? false),
      voiceAgentName: initialData.voiceAgentName ?? "",
      voiceConfidenceThreshold: initialData.voiceConfidenceThreshold ?? 0.4,
      voiceSttProvider: (initialData.voiceSttProvider ??
        undefined) as GptFormValues["voiceSttProvider"],
      voiceSttModelId: initialData.voiceSttModelId ?? undefined,
      voiceSttModelName: initialData.voiceSttModelName ?? undefined,
      voiceTtsProvider: (initialData.voiceTtsProvider ??
